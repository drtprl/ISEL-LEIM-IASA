...
class ProcuraCustoUnif(ProcuraMelhorPrim):
    ...
    melhor-primeiro em que, utilizando o avaliador de uniforme, colocamos os 
    nós na fronteira por ordem crescento segundo o custo do nó sucessor.
    ...
    Este algoritmo é optimo e completo, e face ao complexidade computacional 
